...
public class Naloga31 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < st_ukazov; i++) {
            ...
            case 's':
                int n = Integer.parseInt(ukaz.split(",")[1]);
                seznam.init(n);
                break;
...
class LinkedListArray {
    ...
    // seznam elementov (indeks = pozicija, seznam[indeks] = naslov elementa)
    public LinkedListElement[] pozicije;
    ...
    public void init(int N) {
        ...
        this.pozicije = new LinkedListElement[N*1000];
    }
